...
function copyGeneratedFiles() {
  ...
  find ./ -maxdepth 1 -type f ! \( -name destroy.sh -o -name .env  -o -name .provisioned  -o -name .first_run -o -name README.md -o -name hermes_config.toml -o -name setup.sh -o -name test.sh -o -name Vagrantfile \) -exec mv {} ./tests \;
